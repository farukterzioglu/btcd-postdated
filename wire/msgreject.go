...
const (
	...
	RejectMissingPostD    RejectCode = 0x50
	RejectMultiplePostD   RejectCode = 0x51
)
...
var rejectCodeStrings = map[RejectCode]string{
	...
	RejectMissingPostD:    "REJECT_MISSING_POSTDATED",
	RejectMultiplePostD:   "REJECT_MULTIPLE_POSTDATED",
}
